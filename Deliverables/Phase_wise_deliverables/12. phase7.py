...
def run_lifetrail_agent():
    ...
    # Initialize the retriever tool once
    retriever_tool = create_retriever_tool(
        load_retriever(), 
        "search_financial_docs", 
        "Access 2026 facts on HRA, 80C, 80D, SGB prices, and India Post rules."
    )
    ...
    print("Memory Active. Safety Guardrails Loaded. Type 'exit' to quit.\n")
    ...
    while True:
        ...
        YOUR CORE LOGIC:
        1. PREDICTIVE: Always use the goal tool for calculations. Convert months to years (e.g., 6 months = 0.5 years).
        2. EMPATHETIC: If a user mentions 'guilt' or a 'splurge', use the 'course_correction' tool.
        3. STRATEGIC: If a goal is 'Unrealistic' (more than 50% of income), warn the user.
        4. GROUNDED: Use 'search_financial_docs' for all tax/savings facts.
        5. DEBT PRIORITIZATION: Advise paying off high-interest debt (like bike loans) before low-return savings.
        """
